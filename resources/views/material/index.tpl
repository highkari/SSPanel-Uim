...
注册可免费试用！ &nbsp; <i class="fas fa-chevron-right"></i>
</a>
...
<p class="lead">适用于 macOS、iOS、Android、Windows 和 Linux，借助第三方客户端，可在手机、电脑、路由器、游戏机、电视盒子中使用。</p>
<div class="mt-4">
...
<a href="/user/ticket" class="link-icon">立即咨询 <i class="fas fa-chevron-right"></i></a>
</div>
</div>
</div>
</div>
