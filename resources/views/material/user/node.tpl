                        ...
                        {/if}
                            <div class="node-card node-flex" cardindex="{$node@index}">
                                ...
                                <div class="nodestatus">
                                    <div class="{if $node['online'] == '1'}nodeonline{elseif $node['online'] == '0'}nodeonline{else}nodeonline{/if}">
                                        <i class="material-icons">{if $node['online']=='1'}cloud_queue{elseif $node['online']=='0'}cloud_queue{else}cloud_queue{/if}</i>
                                    </div>
                                </div>
                            </div>
